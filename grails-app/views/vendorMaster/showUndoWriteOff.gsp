    ...
    <div id="list-page">
        <div class="budgetHeader">
            ...
            <div class="headerMainMiddleTwo">
                <div class="ashBtnDiv">
                    <g:link class="ashBtn" style="height: 28px;line-height: 28px;display:inline-block;font-size: 18px;color:#1870b3" action="list"  id="${customerId}" >Back</g:link>
                </div>
            </div>
        </div>  <!--budgetHeader-->
        <div class="singleContainer" >
            ...
            <div class="InvoiceAmountTabl">
                ...
                <g:if test="${customerWriteOffs}">
                    <div class="financeTranTablHead" style="margin-left: 0px;width: 100%">
                        <table style="border-bottom: 1px solid #a5a5a5;">
                            <tbody>
                            <g:each in="${customerWriteOffs}" status="j" var="customerWriteOff">
                                <%
                                    def invoiceNo = customerWriteOff[1]
                                    if(invoiceNo){
                                ...
                                <tr style="background-color: #f9f9f9;">
                                    ...
                                    <td width="25%">${customerWriteOff[2]}</td>
                                    <td width="25%"><bv:euroDotCommaDecimalFormat decimalData="${customerWriteOff[3]}" /></td>
                                    <td width="25%"><a class="dbtBtn debOvr undwr" href="${contextPath}/VendorMaster/undoWriteOff?invoiceNo=${customerWriteOff[0]}&customerId=${customerId}&expenseInvoiceId=${invoiceNo}">Undo Write off</a></td>
                                </tr>
                            </g:each>
                            </tbody>
                        </table>
