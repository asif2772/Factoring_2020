            ...
            <g:form action="update">
                ...
                <div class="btnDivStyle tabFieldsetDiv">
                    ...
                    <% } else { %>
                        ...
                        <g:link controller="customerMaster" action="list" class="orangeBtn" style="height: 27px; margin-right: 12px;"
                        ...
                        <% if (params.fInv) { %>
                            ...
                            %>
                                ...
                                <g:link controller="invoiceIncome" action="list" class="close backBudgetBtn" style="height: 27px; margin-right: 12px;"
                           ...
                           <% }else{ %>
                                <g:link controller="invoiceIncome" action="list" class="close backBudgetBtn" style="height: 27px; margin-right: 12px;"
                                        params="[bookInvoiceId: params.bookInvoiceId, bookingPeriod: params.bookingPeriod,budgetCustomerId: params.budgetCustomerId,customerId: newCustomerId, budgetItemDetailsId: params.budgetItemDetailsId,keepSession:1]">${message(code: 'default.button.BackToInvoice.backInvoice.label', default: 'Back to Invoice')}</g:link>
                            <% } %>

                        <% } %>

                        <% if (params.incBItem) { %>
                            <g:link controller="budgetItemIncomeDetails" action="list" class="close backBudgetBtn" style="height: 27px; margin-right: 12px;"
                                    params="[bookingPeriod: params.bookingPeriod, journalId: params.journalId, customerId: newCustomerId]">${message(code: 'default.button.BackToInvoice.backBudget.label', default: 'Back to Budget')}</g:link>
                        <% } %>
                    ...
                    <% } else { %>
                        ...
                        <g:submitButton name="create" class="save updateBtn" style="width:auto"
                                    value="${message(code: 'default.button.create.label', default: 'Create &')}"/>

                        <g:actionSubmit class="save updateBtn" style="width:auto" action="updateAndCreateDebtor" value="${message(code: 'default.button.updateAndCreateDebtor.label', default: 'Close')}" />
