                ...
                <g:if test="${debtorOutstandingInvoices}">
                    ...
                    <table style="border-bottom: 1px solid #a5a5a5;">
                        ...
                        <tr style="background-color: #fcfcfc;">
                            ...
                            <td width=""><span style="display: block;text-align: left" class="<g:if test="${(creditLimit-totalAmount)>0}">nrmAlrt</g:if><g:else>rdAlrt</g:else>">${Math.round((creditLimit-totalAmount)*100)/100}</span></td>
                        </tr>
                        </tbody>
                    </table>
                </g:if>
